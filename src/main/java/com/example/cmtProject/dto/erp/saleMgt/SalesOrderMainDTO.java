...
public class SalesOrderMainDTO {
    ...
    // SalesOrderDTO를 생성
 	public static SalesOrderMainDTO fromSalesOrder(SalesOrder salesOrder, Clients clients, Products products, Warehouses warehouses, Employees employees, SalesOrderStatus soStatus) {
     	return SalesOrderMainDTO.builder()
