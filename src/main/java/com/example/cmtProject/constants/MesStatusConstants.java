...
public class MesStatusConstants {
    ...
    public static final String ISSUE_STATUS_INSPECT_PASSED = "검사합격";
    public static final String ISSUE_STATUS_INSPECT_FAILED = "검사불합격";
    ...
    public static final String RECEIPT_STATUS_INSPECT_PASSED = "검사합격";
    public static final String RECEIPT_STATUS_INSPECT_FAILED = "검사불합격";
